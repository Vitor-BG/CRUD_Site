...
if (isset($_POST['id'])) {
  $sql = "delete from categoriaproduto where id = " . $_POST['id'];
...
<body style="background-color:#B0C4DE">
  ...
  <div class="container pt-4" style="color:black">
    ...
    <div class="card" style="background-color:#778899">
      <div class="card-body">
        <h1 class="card-title pb-2">Listagem de Categorias de Produtos Cadastrados</h1>
        <a href="categoriaProdutoCadastrar.php" class="pe-2"><button type="button" class="btn btn-primary"><i
      ...
      <tbody>
        ...
        while ($linha = mysqli_fetch_array($resultado)) {
          ...
          <tr>
            ...
            <td class="d-flex">
              <form action="categoriaProdutoEditar.php" method="post">
              ...
              <form action="categoriaProdutoListar.php" method="post"
    ...
    <a href="categoriaProdutoListar.php"><button name="topo" value="Voltar ao Topo" type="submit"
