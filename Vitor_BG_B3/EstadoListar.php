...
if (isset($_POST['id'])) {
  $sql = "delete from estado where id = " . $_POST['id'];
...
<body style="background-color:#B0C4DE">
  ...
  <div class="container pt-4" style="color:black">
    ...
    <div class="card" style="background-color:#778899">
      <div class="card-body">
        <h1 class="card-title pb-2">Listagem de Estados Cadastrados</h1>
        <a href="estadoCadastrar.php" class="pe-2"><button type="button" class="btn btn-primary"><i
      ...
      <tbody>
        ...
        while ($linha = mysqli_fetch_array($resultado)) {
          ...
          <tr>
            ...
            <td class="d-flex">
              <form action="estadoEditar.php" method="post">
              ...
              <form action="estadoListar.php" method="post" onsubmit="return confirm('Deseja realmente excluir?')">
                <input type="hidden" name="id" value="<?= $linha['id'] ?>">
    ...
    <a href="estadoListar.php"><button name="topo" value="Voltar ao Topo" type="submit" class="btn btn-warning mb-3"><i
