...
$sql = "select * from categoriaproduto where id = {$id}";
...
<head>
  ...
  <title>Edição da Categoria de Produto</title>
</head>
  ...
  <div class="container pt-3">
    <?php if (isset($sucesso)): ?>
      <div class="alert alert-success p-3" role="alert">
        <?= $sucesso ?><a href="categoriaProdutoListar.php"><i class="fa-solid fa-list"></i></a>
      </div>
    <?php endif; ?>
  </div>
